...
class TestOtmlWithTAspiration(SimulationTestCase):
    def setUp(self):
        ...
        configurations["LOG_FILE_NAME"] = "{}_td_kg_aiu_aspiration_and_lengthening_400_5_16_{}.txt".format(
            platform.node(), simulation_number)
        self._set_up_logging()
        configurations["CORPUS_DUPLICATION_FACTOR"] = 1
        self.feature_table = FeatureTable.load(
            get_feature_table_fixture("td_kg_aiu_aspiration_and_lengthening_feature_table.json"))
