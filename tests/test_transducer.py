...
from tests.persistence_tools import get_pickle, get_feature_table_fixture
...
class TestTransducer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.arc = Arc(self.state1, Segment('a', self.feature_table), Segment('b', self.feature_table),
                       CostVector([0, 1, 0]), self.state2)
