...
class TestTransducerRepresentations(unittest.TestCase):
    ...
    def setUp(self):
        self.phonotactic_test_feature_table = FeatureTable.load(
            get_feature_table_fixture("phonotactic_test_feature_table"
                                      ".json"))
    ...
    def test_phonotactic_constraint_get_transducer(self):
        phonotactic_constraint = PhonotacticConstraint([{'cons': '+'}, {'labial': '+'}, {'voice': '+'}],
