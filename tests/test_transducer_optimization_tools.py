...
class TestingTransducerOptimizationTools(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.no_CC = PhonotacticConstraint([{'son': '-'}, {'son': '-'}],
                                           self.feature_table).get_transducer()  # p.43 fig. 22
    ...
    def test_remove_suboptimal_paths(self):
        self.assertEqual(self.bb_no_CC_DEP_MAX_removed_suboptimal_paths,
                         get_pickle("bb_no_CC_DEP_MAX_removed_suboptimal_paths"))
